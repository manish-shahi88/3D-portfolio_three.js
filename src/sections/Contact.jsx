...
const Contact = () => {
    ...
    const handleSubmit = async(e) => {
        ...
        setLoading(true)
        try {
            await emailjs.send('service_oj58ry8','template_byl7yqw',{
                from_name: form.name,
                to_name:'Manish',
                from_email: form.email,
                to_email: 'manish.shahi880@gmail.com',
            ...
            <div className="contact-container">
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col space-y-7">
                    ...
                    <label className="space-y-3">
                        ...
                        <input type="email" name="email" value={form.email} onChange={handleChange} required className="field-input" placeholder="john.doe@gmail.com"/>
                    </label>
                    <label className="space-y-3">
